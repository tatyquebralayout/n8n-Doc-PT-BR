...
# <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Autenticação e Acesso
...
## <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Métodos de Autenticação
...
```bash
# <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Variáveis de ambiente para autenticação básica
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configurar política de senhas forte
...
```bash
# <IonicIcon name="document-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Ativar 2FA globalmente
N8N_2FA_ENABLED=true
N8N_2FA_REQUIRED=true

# <IonicIcon name="key-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configurações de 2FA
N8N_2FA_ISSUER=n8n
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração OAuth 2.0
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração OpenID Connect
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração Active Directory
N8N_LDAP_ENABLED=true
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configurar timeout de sessão
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configurar limite de tentativas
...
```bash
# <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configurações de segurança de cookies
...
```bash
# <IonicIcon name="document-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Permitir apenas IPs específicos
...
```nginx
# <IonicIcon name="document-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Restrição por IP no Nginx
location / {
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configurar horários de acesso
...
```bash
#!/bin/bash
# <IonicIcon name="document-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> check-access-hours.sh
...
# <IonicIcon name="sparkles-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Verificar se é dia permitido
if [[ ! $ALLOWED_DAYS =~ $CURRENT_DAY ]]; then
    echo "Acesso negado: Fora dos dias permitidos"
    exit 1
fi

# <IonicIcon name="time-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Verificar se está no horário permitido
...
## <IonicIcon name="git-network-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Integração com Sistemas Externos
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração para Google Workspace
N8N_OAUTH2_ENABLED=true
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração SAML com Google
N8N_SAML_ENABLED=true
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração Azure AD
N8N_OAUTH2_ENABLED=true
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração SAML com Azure AD
N8N_SAML_ENABLED=true
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração GitHub Enterprise
N8N_OAUTH2_ENABLED=true
...
## <IonicIcon name="sparkles-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Monitoramento e Auditoria
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configurar logs de autenticação
N8N_LOG_LEVEL=info
N8N_LOG_FORMAT=json
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configurar alertas de segurança
...
```nginx
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração Nginx com autenticação
server {
...
```nginx
# <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Headers de segurança completos
