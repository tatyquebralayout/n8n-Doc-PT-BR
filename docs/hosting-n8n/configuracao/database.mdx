...
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração de Database
...
## <IonicIcon name="analytics-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Escolha do Banco de Dados
...
## <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração PostgreSQL
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Instalar PostgreSQL
sudo apt update
...
# <IonicIcon name="person-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Criar usuário e banco
...
# <IonicIcon name="sparkles-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Inicializar banco
...
```bash
# <IonicIcon name="cloud-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Executar PostgreSQL com Docker
docker run -d \
  --name postgres-n8n \
  -e POSTGRES_DB=n8n \
  -e POSTGRES_USER=n8n \
...
```bash
# <IonicIcon name="server-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> /etc/postgresql/15/main/pg_hba.conf

# <IonicIcon name="sparkles-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Conexões locais
local   all             postgres                                peer
local   all             all                                     md5

# <IonicIcon name="repeat-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Conexões de rede (ajuste IPs conforme necessário)
...
## <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração MySQL
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Instalar MySQL
sudo apt update
...
```bash
# <IonicIcon name="cloud-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Executar MySQL com Docker
docker run -d \
  --name mysql-n8n \
...
```ini
# <IonicIcon name="server-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> /etc/mysql/mysql.conf.d/mysqld.cnf
...
```bash
# <IonicIcon name="document-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Descomprimir backup
...
```bash
# <IonicIcon name="server-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Master (postgresql.conf)
wal_level = replica
max_wal_senders = 3
wal_keep_segments = 64

# <IonicIcon name="document-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Slave (recovery.conf)
standby_mode = 'on'
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração RDS
DB_TYPE=postgresdb
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração Cloud SQL
DB_TYPE=postgresdb
...
## <IonicIcon name="cloud-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Docker Compose
