...
# <IonicIcon name="document-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Escalonamento
...
## <IonicIcon name="sparkles-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> O que você vai encontrar
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Por que Escalar?
...
## <IonicIcon name="grid-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Arquitetura de Escalonamento
...
## <IonicIcon name="document-text-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Guia de Implementação
