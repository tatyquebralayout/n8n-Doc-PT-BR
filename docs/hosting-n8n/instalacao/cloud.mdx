...
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Instalação na Nuvem
...
## <IonicIcon name="cloud-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Opções de Cloud
...
## <IonicIcon name="analytics-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Monitoramento e Analytics
...
## <IonicIcon name="cloud-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Self-hosted em Cloud
...
```bash
# <IonicIcon name="sparkles-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Criar instância EC2
...
# <IonicIcon name="sparkles-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Conectar via SSH
ssh -i sua-key.pem ubuntu@seu-ip

# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Instalar Docker
sudo apt update
sudo apt install docker.io docker-compose

# <IonicIcon name="document-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Executar n8n
docker run -d \
  --name n8n \
  -p 80:5678 \
...
```yaml
# <IonicIcon name="git-branch-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> task-definition.json
{
  "family": "n8n",
  "networkMode": "awsvpc",
...
```bash
# <IonicIcon name="sparkles-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Criar instância
...
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Instalar e executar n8n
sudo apt update
sudo apt install docker.io docker-compose
...
```yaml
# <IonicIcon name="cloud-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> cloudbuild.yaml
steps:
...
```bash
# <IonicIcon name="sparkles-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Criar VM
az vm create \
...
```bash
# <IonicIcon name="person-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Criar container
az container create \
  --resource-group n8n-rg \
  --name n8n-container \
  --image n8nio/n8n:latest \
...
```yaml
# <IonicIcon name="cloud-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> AWS Application Load Balancer
apiVersion: v1
kind: Service
metadata:
  name: n8n-service
...
```yaml
# <IonicIcon name="cloud-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Kubernetes HPA
...
```yaml
# <IonicIcon name="document-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Prometheus monitoring
apiVersion: v1
kind: ConfigMap
metadata:
