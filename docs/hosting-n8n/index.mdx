...
- [Guia de instalação do n8n em diferentes ambientes](../primeiros-passos/instalacao.mdx)
- [Configuração de segurança e compliance LGPD](../privacidade-seguranca/security-best-practices.md)
...
1. **Escolha sua [Instalação](../primeiros-passos/instalacao.mdx)** baseada em suas necessidades
2. **Configure [Segurança](../privacidade-seguranca/security-best-practices.md)** para proteger sua instância
