...
## <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Instalação e Configuração {#instalacao-e-configuracao}
...
## <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Segurança e Compliance {#seguranca-e-compliance}
...
## <IonicIcon name="trending-up-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Escalonamento {#escalonamento}
...
## <IonicIcon name="cloud-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Cloud e On-Premises {#cloud-e-on-premises}
...
## <IonicIcon name="git-network-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Arquiteturas de Deploy {#arquiteturas-de-deploy}
