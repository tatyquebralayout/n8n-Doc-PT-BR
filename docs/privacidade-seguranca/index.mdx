...
## <IonicIcon name="document-text-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Compromisso com a Privacidade
...
## <IonicIcon name="lock-closed-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Segurança de Dados
...
## <IonicIcon name="help-circle-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Suporte e Contato
