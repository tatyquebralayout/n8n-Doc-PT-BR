...
## <IonicIcon name="eye-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Visão Geral
...
#### <IonicIcon name="play-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Instalação Básica
...
## <IonicIcon name="construct-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração
...
#### <IonicIcon name="server-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Com Nginx
...
#### <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Com Certbot (Lets Encrypt)
...
## <IonicIcon name="trending-up-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Escalabilidade
...
## <IonicIcon name="lock-closed-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Segurança
...
## <IonicIcon name="save-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Backup e Recuperação
...
## <IonicIcon name="analytics-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Monitoramento
...
## <IonicIcon name="refresh-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Atualizações
...
## <IonicIcon name="cloud-upload-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Migração para o Cloud
