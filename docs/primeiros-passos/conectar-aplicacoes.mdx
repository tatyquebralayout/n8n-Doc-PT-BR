...
1. **Explore as [Integrações](../integracoes/index.mdx)** disponíveis
2. **Aprenda sobre [Credenciais](../usando-n8n/credenciais)** em detalhes
3. **Crie seu primeiro workflow** com integrações
4. **Experimente com [Lógica e Dados](../logica-e-dados/index.mdx)**

## <ion-icon name="help-circle-outline" style={{ fontSize: '24px', color: '#ea4b71' }}></ion-icon> Recursos Relacionados

- **[Integrações](../integracoes/index.mdx)** - Catálogo completo de nodes
...
**<ion-icon name="link-outline" style={{ fontSize: '16px', color: '#ea4b71' }}></ion-icon> Pronto para conectar suas aplicações? Comece explorando as [integrações disponíveis](../integracoes/index.mdx)!**
