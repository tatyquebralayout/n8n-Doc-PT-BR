...
# <IonicIcon name="link-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Conectar Aplicações
...
## <IonicIcon name="key-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Conceitos Fundamentais
...
## <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configurando Credenciais
...
## <IonicIcon name="grid-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Tipos de Integrações
...
## <IonicIcon name="code-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Nodes de Integração
...
**<IonicIcon name="link-outline" style={{ fontSize: '16px', color: '#ea4b71' }} /> Pronto para conectar suas aplicações? Comece explorando as [integrações disponíveis](../integracoes/)!**
