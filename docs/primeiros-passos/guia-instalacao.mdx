...
<IonicIcon name="settings-outline" style={{ fontSize: '32px', color: '#cor-ea4b71-guia-de Instalação do **n8n** – Visão Panorâmica
...
#ionicicon-namesettings-outline-style-fontsize-24px color: '#cor-ea4b71-por-que três rotas de instalação?
...
#ionicicon-namesettings-outline-style-fontsize-24px color: '#cor-ea4b71-plataformas-disponveis

#n8n-cloud-o-que é?** Serviço totalmente hospedado, gerenciado e escalável pelos criadores do n8n.
...
#selfhosted-autohospedado-o-que é?** Você instala o n8n em sua própria infraestrutura – VPS, bare‑metal ou Kubernetes.
* **Opções disponíveis**
...
#ionicicon-namechevron-forward-outline-style-fontsize-24px color: '#cor-ea4b71-qual-rota escolher?
...
#ionicicon-nameshield-checkmark-outline-style-fontsize-24px color: '#cor-ea4b71-licenas-e Versões

#verses-gratuitas-n8n-cloud Trial gratuito de 14 dias
* **Self-hosted Community Edition**: Totalmente gratuito
* **npm local**: Totalmente gratuito

#verses-pagas-n8n-cloud Planos pagos por usuário/execuções
* **Self-hosted Enterprise**: Licença comercial para recursos avançados

#licenciamento-o-n8n-utiliza-o modelo **fair-code**:
* **Sustainable Use License** para a Community Edition
* **Enterprise License** para recursos comerciais

---

#ionicicon-namechevron-forward-outline-style-fontsize-24px color: '#cor-ea4b71-prximos-passos
...
<div style={{fontSize: '1.2em', fontWeight: 'bold', margin: '2rem 0', padding: '1rem', borderLeft: '4px solid #cor-ea4b71-backgroundcolor#cor-f8f9fa-siga-conosco-nas-prximas páginas para mergulhar em cada opção e escolher, implementar e manter o método que mais se ajusta ao seu projeto.**
