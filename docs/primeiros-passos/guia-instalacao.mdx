...
1. **[n8n Cloud](./instalacao-cloud)** - Para agilidade
2. **[Self-Hosted](./instalacao-self-hosted)** - Para controle total
3. **[Instalação Local](./instalacao-npm)** - Para desenvolvimento

> *Comece com n8n Cloud se você é iniciante. Você pode migrar para self-hosted posteriormente conforme suas necessidades evoluem.*
