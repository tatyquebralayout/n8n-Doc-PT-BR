...
keywords: [n8n, cloud, saas, instalação, configuração, planos]
---
...
O n8n Cloud está disponível globalmente com data centers em múltiplas regiões para garantir baixa latência.
:::
...
- **Comunidade**: [Discord](https://discord.gg/n8nbrasil)
