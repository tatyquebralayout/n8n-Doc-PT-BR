...
# <IonicIcon name="settings-outline" style={{ fontSize: '32px', color: '#ea4b71' }} /> Instalação Self-hosted do n8n
...
<IonicIcon name="alert-triangle-outline" style={{ fontSize: '16px', color: '#f59e0b' }} /> O self-hosting do n8n requer conhecimento técnico, incluindo:
...
:::note **Versões do n8n**
<IonicIcon name="time-outline" style={{ fontSize: '16px', color: '#3b82f6' }} /> O n8n lança uma nova versão menor na maioria das semanas. A versão `latest` é para uso em produção. `next` é a versão mais recente e deve ser tratada como beta: pode ser instável.

**Versão atual `latest`**: 1.101.1  
**Versão atual `next`**: 1.102.1
:::

## <IonicIcon name="list-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Pré-requisitos
...
:::note **Usuários Linux**
<IonicIcon name="desktop-outline" style={{ fontSize: '16px', color: '#3b82f6' }} /> O Docker Desktop está disponível para Mac e Windows. Usuários Linux devem instalar o [Docker Engine](https://docs.docker.com/engine/install/) e [Docker Compose](https://docs.docker.com/compose/install/) individualmente para sua distribuição.
:::

## <IonicIcon name="download-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Métodos de Instalação
...
* <IonicIcon name="checkmark-circle-outline" style={{ fontSize: '16px', color: '#10b981' }} /> Instala o n8n em um ambiente limpo
* <IonicIcon name="checkmark-circle-outline" style={{ fontSize: '16px', color: '#10b981' }} /> Configuração mais fácil para seu banco de dados preferido
* <IonicIcon name="checkmark-circle-outline" style={{ fontSize: '16px', color: '#10b981' }} /> Evita problemas devido a diferentes sistemas operacionais
* <IonicIcon name="checkmark-circle-outline" style={{ fontSize: '16px', color: '#10b981' }} /> Evita problemas de compatibilidade
* <IonicIcon name="checkmark-circle-outline" style={{ fontSize: '16px', color: '#10b981' }} /> Facilita a migração para novos hosts ou ambientes
...
<details>
<summary><IonicIcon name="settings-outline" style={{ fontSize: '16px', color: '#6b7280' }} /> <strong>Configurações Avançadas do Docker</strong> <IonicIcon name="chevron-down-outline" style={{ fontSize: '14px', color: '#6b7280' }} /></summary>
...
## <IonicIcon name="construct-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração Inicial
...
:::warning **Importante**
<IonicIcon name="shield-checkmark-outline" style={{ fontSize: '16px', color: '#f59e0b' }} /> Na primeira execução, você deve criar uma conta de administrador para proteger sua instância.
:::
...
<details>
<summary><IonicIcon name="options-outline" style={{ fontSize: '16px', color: '#6b7280' }} /> <strong>Configurações Avançadas</strong> <IonicIcon name="chevron-down-outline" style={{ fontSize: '14px', color: '#6b7280' }} /></summary>
...
## <IonicIcon name="search-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Verificando a Instalação
...
## <IonicIcon name="refresh-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Atualizando o n8n
...
<IonicIcon name="cloud-upload-outline" style={{ fontSize: '16px', color: '#3b82f6' }} /> Sempre faça backup dos seus dados antes de atualizar o n8n em produção.
:::

## <IonicIcon name="medical-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Solução de Problemas
...
<details>
<summary><IonicIcon name="analytics-outline" style={{ fontSize: '16px', color: '#6b7280' }} /> <strong>Comandos de Diagnóstico Avançados</strong> <IonicIcon name="chevron-down-outline" style={{ fontSize: '14px', color: '#6b7280' }} /></summary>
...
## <IonicIcon name="arrow-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Próximos Passos

Agora que o n8n está instalado e funcionando:

- [x] <IonicIcon name="checkmark-circle-outline" style={{ fontSize: '16px', color: '#10b981' }} /> **Instalação concluída**
- [ ] <IonicIcon name="book-outline" style={{ fontSize: '16px', color: '#6b7280' }} /> **[Conceitos Fundamentais](./conceitos-fundamentais)** - Entenda os fundamentos
- [ ] <IonicIcon name="play-outline" style={{ fontSize: '16px', color: '#6b7280' }} /> **[Primeiro Workflow](./primeiro-workflow)** - Crie seu primeiro fluxo
- [ ] <IonicIcon name="link-outline" style={{ fontSize: '16px', color: '#6b7280' }} /> **[Conectar Aplicações](./conectar-aplicacoes)** - Integre suas ferramentas

### Outros Métodos de Instalação

- <IonicIcon name="cloud-outline" style={{ fontSize: '16px', color: '#3b82f6' }} /> **[n8n Cloud](./instalacao-cloud)** - Instalação via serviço hospedado
- <IonicIcon name="code-outline" style={{ fontSize: '16px', color: '#6b7280' }} /> **[Self-hosted (Auto-hospedado)](./instalacao-self-hosted)** - Para desenvolvimento e produção
