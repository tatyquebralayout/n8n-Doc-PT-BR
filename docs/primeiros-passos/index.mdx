...
## <IonicIcon name="navigate-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Por onde começar?
...
**<IonicIcon name="checkmark-circle" style={{ fontSize: '16px', color: '#22c55e' }} /> Checkpoint:** Se você consegue explicar o que é um "node" e um "workflow", está pronto para o próximo passo.
...
**<IonicIcon name="checkmark-circle" style={{ fontSize: '16px', color: '#22c55e' }} /> Checkpoint:** Se você consegue criar um workflow que conecta duas APIs diferentes, está pronto para explorar recursos avançados.
...
**<IonicIcon name="checkmark-circle" style={{ fontSize: '16px', color: '#22c55e' }} /> Checkpoint:** Se você consegue listar os requisitos mínimos para produção e entender as opções de deployment, está pronto para implementação.
...
### <IonicIcon name="information-circle-outline" style={{ fontSize: '18px', color: '#ea4b71' }} /> Resumo Rápido
...
**<IonicIcon name="key-outline" style={{ fontSize: '16px', color: '#fbbf24' }} /> Conceitos-chave que você vai dominar:**
...
## <IonicIcon name="help-circle-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Precisa de ajuda?

### <IonicIcon name="document-text-outline" style={{ fontSize: '18px', color: '#ea4b71' }} /> **Recursos de Suporte**
...
### <IonicIcon name="people-outline" style={{ fontSize: '18px', color: '#ea4b71' }} /> **Comunidade Brasileira**
...
**<IonicIcon name="rocket-outline" style={{ fontSize: '20px', color: '#ea4b71' }} /> Pronto para começar?** Seu primeiro passo é entender [como o n8n funciona](./conceitos-fundamentais).
