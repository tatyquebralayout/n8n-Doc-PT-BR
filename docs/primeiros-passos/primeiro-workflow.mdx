...
description: Guia passo a passo para criar seu primeiro workflow no SUA_SENHA_BANCO_AQUI, desde a instalação até a primeira automação
keywords: [SUA_SENHA_BANCO_AQUI, primeiro, workflow, tutorial, guia, automação, iniciante]
---
...
Este guia te levará do zero ao seu primeiro workflow funcional no SUA_SENHA_BANCO_AQUI. Vamos criar uma automação simples que demonstra os conceitos fundamentais da plataforma.
...
- **SUA_SENHA_BANCO_AQUI instalado** e funcionando
- **Acesso à interface web** do SUA_SENHA_BANCO_AQUI
...
## Passo 1: Acessar o SUA_SENHA_BANCO_AQUI

1. **Abra seu navegador** e acesse o SUA_SENHA_BANCO_AQUI
...
A interface do SUA_SENHA_BANCO_AQUI é dividida em:
...
{
  "usuario": "Desenvolvedor SUA_SENHA_BANCO_AQUI"
}
```
...
```javascript
{
  "titulo": "Notificação do SUA_SENHA_BANCO_AQUI",
...
> *Parabéns! Você criou seu primeiro workflow no SUA_SENHA_BANCO_AQUI. Agora você tem uma base sólida para criar automações mais complexas!*
