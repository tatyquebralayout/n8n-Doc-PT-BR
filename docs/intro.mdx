...
**Checkpoint Intermediário:** <ion-icon name="checkmark-circle" style={{ fontSize: '16px', color: '#22c55e' }}></ion-icon> Se você já programa em JavaScript, pode começar imediatamente com nós de código customizados. Veja **[Integrações Avançadas](./integracoes/index.mdx)** para exemplos práticos.
...
**Checkpoint de validação:** <ion-icon name="checkmark-circle" style={{ fontSize: '16px', color: '#22c55e' }}></ion-icon> Se você consegue criar uma planilha no Excel com fórmulas, consegue criar workflows no n8n. Veja **[Primeiro Workflow](./primeiros-passos/primeiro-workflow.mdx)** para começar.
...
**Checkpoint Intermediário:** <ion-icon name="checkmark-circle" style={{ fontSize: '16px', color: '#22c55e' }}></ion-icon> Para implementação empresarial, consulte **[Deployment em Produção](./hosting-n8n/index.mdx)** e **[Configuração de Segurança](./hosting-n8n/seguranca/index.mdx)**.
...
**[Interface e Navegação](./usando-n8n/interface/index.mdx)** - Dominando o editor visual  
**[Lógica e Fluxo de Dados](./logica-e-dados/index.mdx)** - Condicionais, loops, error handling  
**[Integrações Avançadas](./integracoes/index.mdx)** - APIs customizadas, webhooks  
...
**[API Reference](./api/index.mdx)** - Documentação completa da REST API  
**[Deployment em Produção](./hosting-n8n/index.mdx)** - Clustering, monitoramento, backup  
**[Criando Nodes Customizados](./integracoes/criar-nodes/index.mdx)** - Desenvolvimento avançado  

### <ion-icon name="star" style={{ fontSize: '18px', color: '#ea4b71' }}></ion-icon> **Recursos Especializados**

**[Integrações Brasileiras](./integracoes-br/index.mdx)** - PIX, ViaCEP, Receita Federal  
**[Casos de Uso Avançados](./comunidade/casos-uso-avancados/index.mdx)** - E-commerce, SaaS, Fintech  
**[Troubleshooting](./referencia/guias/index.mdx)** - Diagnóstico e resolução de problemas  
