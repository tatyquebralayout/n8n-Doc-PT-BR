...
# <IonicIcon name="create-outline" size={32} color="#ea4b71" /> Programa para Criadores de Conteúdo (Creators)
...
## <IonicIcon name="apps-outline" size={24} color="#ea4b71" /> Duas Formas Principais de Criar Conteúdo
