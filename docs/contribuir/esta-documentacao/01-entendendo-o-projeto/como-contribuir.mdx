...
# <span style={{display: 'flex', alignItems: 'center', gap: '12px'}}><IonicIcon name="git-pull-request-outline" size={32} color="#ea4b71" /> Como Contribuir</span>
...
## <span style={{display: 'flex', alignItems: 'center', gap: '8px'}}><IonicIcon name="rocket-outline" size={24} color="#ea4b71" /> Início Rápido (5 minutos)</span>

### <span style={{display: 'flex', alignItems: 'center', gap: '6px'}}><IonicIcon name="code-outline" size={20} color="#ea4b71" /> Contribuições sem código</span>
...
### <span style={{display: 'flex', alignItems: 'center', gap: '6px'}}><IonicIcon name="logo-github" size={20} color="#ea4b71" /> **[<span style={{fontSize: '0.9em'}}>Link Direto para Contribuir</span>](https://github.com/tatyquebralayout/n8n-Doc-pt-BR)**</span>

---

## <span style={{display: 'flex', alignItems: 'center', gap: '8px'}}><IonicIcon name="construct-outline" size={24} color="#ea4b71" /> Configuração do Ambiente</span>
...
## <span style={{display: 'flex', alignItems: 'center', gap: '8px'}}><IonicIcon name="git-branch-outline" size={24} color="#ea4b71" /> Fluxo de Contribuição</span>
...
:::tip <span style={{display: 'flex', alignItems: 'center', gap: '6px'}}><IonicIcon name="star" size={16} color="#f59e0b" /> <span style={{color: '#f59e0b'}}>Vantagem</span></span>
...
## <span style={{display: 'flex', alignItems: 'center', gap: '8px'}}><IonicIcon name="document-outline" size={24} color="#ea4b71" /> Tipos de Contribuição</span>
...
## <span style={{display: 'flex', alignItems: 'center', gap: '8px'}}><IonicIcon name="shield-checkmark-outline" size={24} color="#ea4b71" /> Checklist de Qualidade</span>
...
## <span style={{display: 'flex', alignItems: 'center', gap: '8px'}}><IonicIcon name="people-outline" size={24} color="#ea4b71" /> Processo de Revisão</span>
...
```bash title="Terminal"
# Faça as edições solicitadas
# (edite os arquivos conforme o feedback)
...
> 
> **<IonicIcon name="eye-outline" size={16} color="#ea4b71" /> [Ver Issues Disponíveis](https://github.com/tatyquebralayout/n8n-Doc-pt-BR/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)** | **<IonicIcon name="chatbubbles-outline" size={16} color="#ea4b71" /> [Fazer uma Pergunta](https://github.com/tatyquebralayout/n8n-Doc-pt-BR/discussions)**
