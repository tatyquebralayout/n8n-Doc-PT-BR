...
> **<IonicIcon name="rocket" size={16} color="#ea4b71" /> Pronto para contribuir?** 
> 
> Escolha uma issue marcada como `good first issue` e siga este guia. A comunidade está aqui para ajudar em cada passo! Todas as pessoas são bem-vindas, independente do seu nível de experiência.
> 
