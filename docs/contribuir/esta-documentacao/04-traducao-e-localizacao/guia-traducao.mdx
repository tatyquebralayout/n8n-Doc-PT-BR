...
# <ion-icon name="document-text-outline" style={{ fontSize: '32px', color: '#ea4b71' }}></ion-icon> Guia de Tradução e Localização

## <ion-icon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }}></ion-icon> Objetivo
...
## <ion-icon name="location-outline" style={{ fontSize: '24px', color: '#ea4b71' }}></ion-icon> Princípios da Localização
...
## <ion-icon name="git-branch-outline" style={{ fontSize: '24px', color: '#ea4b71' }}></ion-icon> Processo de Tradução
...
## <ion-icon name="language-outline" style={{ fontSize: '24px', color: '#ea4b71' }}></ion-icon> Diretrizes de Tradução
...
## <ion-icon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }}></ion-icon> Tipos de Conteúdo
...
## <ion-icon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }}></ion-icon> Colaboração
...
## <ion-icon name="analytics-outline" style={{ fontSize: '24px', color: '#ea4b71' }}></ion-icon> Métricas de Sucesso
...
<ion-icon name="help-circle-outline" style={{ fontSize: '20px', color: '#ea4b71' }}></ion-icon> **Precisa de ajuda?** Abra uma [discussão](https://github.com/n8n-io/n8n-docs-br/discussions) ou [issue](https://github.com/n8n-io/n8n-docs-br/issues) para colaborarmos juntos na tradução.
