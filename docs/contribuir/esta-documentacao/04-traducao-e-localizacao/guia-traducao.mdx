...
# <LocalIcon name="language-outline" size={32} color="#ea4b71" /> Guia de Tradução e Localização

## <LocalIcon name="target-outline" size={24} color="#ea4b71" /> Objetivo
...
## <LocalIcon name="compass-outline" size={24} color="#ea4b71" /> Princípios da Localização
...
## <LocalIcon name="git-branch-outline" size={24} color="#ea4b71" /> Processo de Tradução
...
## <LocalIcon name="document-outline" size={24} color="#ea4b71" /> Diretrizes de Tradução
...
## <LocalIcon name="bulb-outline" size={24} color="#ea4b71" /> Exemplos Práticos
...
## <LocalIcon name="checkbox-outline" size={24} color="#ea4b71" /> Checklist de Qualidade
...
## <LocalIcon name="bulb-outline" size={24} color="#ea4b71" /> Tipos de Conteúdo
...
## <LocalIcon name="people-outline" size={24} color="#ea4b71" /> Colaboração
...
## <LocalIcon name="bar-chart-outline" size={24} color="#ea4b71" /> Métricas de Sucesso
...
<LocalIcon name="help-circle-outline" size={20} color="#ea4b71" /> **Precisa de ajuda?** Abra uma [discussão](https://github.com/n8n-io/n8n-docs-br/discussions) ou [issue](https://github.com/n8n-io/n8n-docs-br/issues) para colaborarmos juntos na tradução.
