...
## <LocalIcon name="brush-outline" size={24} color="#8b5cf6" /> Cores de Destaque
...
## <LocalIcon name="code-outline" size={24} color="#f59e0b" /> Como Usar
...
## <LocalIcon name="contrast-outline" size={24} color="#374151" /> Acessibilidade
...
## <LocalIcon name="color-filter-outline" size={24} color="#ea4b71" /> Exemplos Práticos
...
```jsx
// Sucesso
<LocalIcon name="checkmark-circle" color="#10b981" />

// Em execução  
<LocalIcon name="time" color="#f59e0b" />

// Erro
<LocalIcon name="close-circle" color="#ef4444" />
```

---

## <LocalIcon name="checkmark-done-outline" size={24} color="#10b981" /> Checklist de Cores
...
**<LocalIcon name="color-palette-outline" size={16} color="#ea4b71" /> Uma paleta consistente cria uma experiência visual coesa e profissional!** 
