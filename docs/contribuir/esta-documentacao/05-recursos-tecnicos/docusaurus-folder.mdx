...
# <LocalIcon name="code-working-outline" size={32} color="#ea4b71" /> Entendendo o Diretório .docusaurus

## <LocalIcon name="help-circle-outline" size={24} color="#ea4b71" /> O que é?
...
## <LocalIcon name="time-outline" size={24} color="#ea4b71" /> Quando e como ele é gerado?
...
## <LocalIcon name="folder-outline" size={24} color="#ea4b71" /> Estrutura interna: o que tem lá dentro?
...
## <LocalIcon name="git-branch-outline" size={24} color="#ea4b71" /> Fluxo de Geração (Visual)
...
## <LocalIcon name="terminal-outline" size={24} color="#ea4b71" /> Comandos úteis
...
## <LocalIcon name="checkmark-circle-outline" size={24} color="#ea4b71" /> Boas práticas
...
## <LocalIcon name="document-text-outline" size={24} color="#ea4b71" /> Exemplo de arquivos
...
## <LocalIcon name="bulb-outline" size={24} color="#ea4b71" /> Conclusão
