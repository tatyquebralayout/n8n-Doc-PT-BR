...
# <IonicIcon name="color-palette-outline" size={32} color="#ea4b71" /> Guia de Estilo

Este guia estabelece os **padrões de estilo e formatação** para manter consistência na documentação n8n Brasil.

---

## <IonicIcon name="chatbubbles-outline" size={24} color="#10b981" /> Tom de Voz
...
## <IonicIcon name="text-outline" size={24} color="#ea4b71" /> Formatação
...
## <IonicIcon name="code-outline" size={24} color="#f59e0b" /> Código e Exemplos
...
## <IonicIcon name="grid-outline" size={24} color="#8b5cf6" /> Tabelas
...
## <IonicIcon name="image-outline" size={24} color="#06b6d4" /> Imagens e Screenshots
...
## <IonicIcon name="link-outline" size={24} color="#84cc16" /> Links e Referências
...
## <IonicIcon name="color-palette-outline" size={24} color="#ec4899" /> Componentes Customizados

### **IonicIcon**
```markdown
<IonicIcon name="checkmark-outline" size={24} color="#10b981" />
```
...
## <IonicIcon name="checkmark-done-outline" size={24} color="#10b981" /> Checklist de Qualidade
...
**<IonicIcon name="star-outline" size={16} color="#ea4b71" /> Seguir estes padrões garante uma documentação consistente e profissional para toda a comunidade!** 
