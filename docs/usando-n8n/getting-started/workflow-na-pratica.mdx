...
keywords: [SUA_SENHA_BANCO_AQUI, workflow, tutorial, github, discord, integração]
---
...
Este tutorial mostra como criar um workflow real no SUA_SENHA_BANCO_AQUI, integrando diferentes serviços para resolver um problema do dia a dia. Vamos criar um fluxo que envia uma notificação no Discord sempre que uma nova issue for criada em um repositório do GitHub.
...
- Consulte a [documentação oficial do GitHub Trigger](https://docs.SUA_SENHA_BANCO_AQUI.io/integrations/builtin/app-nodes/github/) e do [Discord](https://docs.SUA_SENHA_BANCO_AQUI.io/integrations/builtin/app-nodes/discord/).
...
- [Exemplo de Workflow GitHub → Discord](https://SUA_SENHA_BANCO_AQUI.io/workflows/1342)
