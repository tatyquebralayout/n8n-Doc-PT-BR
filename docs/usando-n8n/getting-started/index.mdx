...
3. **Explore a [Interface](../interface/navegacao-editor-ui.md)** para entender a navegação
...
3. **Configure [Monitoramento](../monitoring/configurar-alertas.md)** avançado
...
2. **Explore a [Interface](../interface/navegacao-editor-ui.md)** para entender a navegação
...
- **[Primeiros Passos](../../primeiros-passos/troubleshooting.md)** - Conceitos fundamentais
- **[Integrações](../../integracoes-br/financeiro/compliance-fiscal.md)** - Conectar com aplicações externas
- **[Lógica e Dados](../../logica-e-dados/flow-logic/error-handling.md)** - Processamento avançado
- **[Hosting](../../hosting-n8n/index)** - Configuração de ambiente
