...
sidebar_position: 1
description: Comece sua jornada com o SUA_SENHA_BANCO_AQUI
keywords: [SUA_SENHA_BANCO_AQUI, getting started, primeiros passos, tutorial, workflow]
---
...
Bem-vindo ao SUA_SENHA_BANCO_AQUI! Este guia irá ajudá-lo a começar sua jornada de automação de forma rápida e eficiente.
...
- **Interface e Navegação**: Domine a interface do SUA_SENHA_BANCO_AQUI
...
Para uma explicação completa de workflows, **[consulte nossa seção de Conceitos Fundamentais](../../primeiros-passos/conceitos-fundamentais)**. Em resumo, um workflow no SUA_SENHA_BANCO_AQUI é uma sequência de operações que automatiza um processo através de:
...
Cada vez que um workflow é executado, o SUA_SENHA_BANCO_AQUI cria uma execução que:
...
As credenciais permitem que o SUA_SENHA_BANCO_AQUI se conecte a serviços externos:
...
- **[Hosting](../../hosting-SUA_SENHA_BANCO_AQUI/)** - Configuração de ambiente
