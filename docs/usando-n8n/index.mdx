...
:::info
<IonicIcon name="git-branch-outline" style={{fontSize: '18px', color: '#ea4b71'}} /> Esta seção reúne **guias práticos, passo a passo, troubleshooting e exemplos de uso** do n8n. Para fundamentos técnicos, arquitetura e lógica de dados, acesse a seção [Lógica e Dados](../logica-e-dados/flow-logic/error-handling.md).
:::
