...
:::info
<IonicIcon name="git-branch-outline" style={{ fontSize: '18px', color: '#ea4b71' }} />
...
## <IonicIcon name="rocket-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Getting Started {#getting-started}
...
## <IonicIcon name="desktop-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Interface {#interface}

- **[Navegação e Editor UI](./interface/navegacao-editor-ui)** – Conheça a interface do n8n

---

## <IonicIcon name="git-branch-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Workflows {#workflows}
...
## <IonicIcon name="analytics-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Execuções {#execucoes}
...
## <IonicIcon name="people-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Usuários e Permissões {#usuarios-e-permissoes}
...
## <IonicIcon name="trending-up-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Monitoramento {#monitoring}
...
## <IonicIcon name="checkmark-circle-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Boas Práticas {#boas-praticas}
