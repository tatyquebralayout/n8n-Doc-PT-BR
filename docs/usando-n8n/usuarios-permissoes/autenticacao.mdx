...
# <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Autenticação
...
## <IonicIcon name="key-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Métodos de Autenticação
...
## <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração de Segurança
...
## <IonicIcon name="shield-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Integração com Provedores Externos
...
**<IonicIcon name="shield-checkmark-outline" style={{ fontSize: '16px', color: '#ea4b71' }} /> Pronto para proteger? Comece configurando 2FA para seus usuários!**
