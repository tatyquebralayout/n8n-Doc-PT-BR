...
# <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Roles e Permissões
...
## <IonicIcon name="people-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Sistema de Roles
...
## <IonicIcon name="key-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Tipos de Permissões
...
## <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração de Permissões
...
## <IonicIcon name="analytics-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Auditoria e Monitoramento
...
**<IonicIcon name="shield-checkmark-outline" style={{ fontSize: '16px', color: '#ea4b71' }} /> Pronto para controlar? Comece configurando roles apropriados para sua equipe!**
