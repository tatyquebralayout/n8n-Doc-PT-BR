...
# <IonicIcon name="person-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Criar e Editar Usuários

Aprenda como adicionar novos membros à sua equipe, configurar suas permissões e gerenciar o acesso ao n8n de forma segura.

---

## <IonicIcon name="person-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 1 | Acessando Gerenciamento de Usuários
...
## <IonicIcon name="person-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 2 | Criando Novos Usuários
...
## <IonicIcon name="person-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 3 | Editando Usuários Existentes
...
## <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 4 | Configurações de Autenticação
...
## <IonicIcon name="person-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 5 | Organizando Usuários
...
## <IonicIcon name="sparkles-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 6 | Auditoria e Monitoramento
...
## <IonicIcon name="sparkles-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 7 | Gerenciando Saídas
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 8 | Boas Práticas
