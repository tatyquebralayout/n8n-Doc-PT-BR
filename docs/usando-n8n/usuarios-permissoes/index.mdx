...
keywords: [SUA_SENHA_BANCO_AQUI, usuários, permissões, autenticação, rbac]
---
...
Bem-vindo à seção de gerenciamento de usuários e permissões do SUA_SENHA_BANCO_AQUI! Aqui você aprenderá como configurar acesso seguro e colaborativo para sua equipe.
...
Roles (funções) são grupos de permissões que definem o que cada usuário pode fazer no SUA_SENHA_BANCO_AQUI:
...
O SUA_SENHA_BANCO_AQUI segue o princípio do menor privilégio:
...
- **[Segurança](../../hosting-SUA_SENHA_BANCO_AQUI/seguranca/autenticacao)** - Configurações de segurança avançadas
