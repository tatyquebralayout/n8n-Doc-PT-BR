#configuraes-de-workflow-as-configuraes de workflow permitem personalizar o comportamento, performance e aparência dos seus workflows no n8n. Esta seção aborda todas as opções de configuração disponíveis para otimizar seus workflows.

#viso-geral-as-configuraes-de workflow oferecem controle granular sobre como seus workflows funcionam, incluindo:
...
#cor-acessando-as-configuraes

#interface-web-para-acessar-as configurações de um workflow:
...
#configuraes-globais-algumas-configuraes-podem ser definidas globalmente:

```bash
#configuraes-de-ambiente-export-n8nworkflowtimeout3600000
...
#timeout-de-execuo-defina-o tempo máximo que um workflow pode executar:
...
#limite-de-execues-configure-limites para evitar sobrecarga:
...
#configuraes-de-performance-otimize-a performance do workflow:
...
#mapeamento-de-dados-configure-como os dados são processados:
...
#validao-de-dados-configure-validaes automáticas:
...
#cor-cache-de-dados-configure-cache para melhorar performance:
...
#visualizao-do-workflow-personalize-a aparência do workflow:
...
#configuraes-de-navegao-configure-a navegação no editor:
...
#controle-de-acesso-configure-permisses e acesso:
...
#configuraes-de-rede-configure-acesso de rede:
...
#alertas-e-notificaes-configure-notificaes automáticas:
...
#configuraes-de-email-configure-notificaes por email:
...
#mtricas-e-analytics-configure-coleta de métricas:
...
#logs-e-debugging-configure-logs detalhados:
...
#configuraes-de-filas-configure-processamento em fila:
...
#configuraes-especficas-para-brasil

#configuraes-de-lgpd-configure-conformidade com LGPD:
...
#configuraes-de-moeda-configure-para Real brasileiro:
...
#aplicando-configuraes

#via-interface-1-abra-as configurações** do workflow
2. **Navegue pelas abas** de configuração
3. **Modifique os valores** conforme necessário
4. **Clique em "Save"** para aplicar

#via-api-javascript-atualizar configurações via API
...
#via-variveis-de-ambiente-bash
#configuraes-globais-via-ambiente-export N8N_WORKFLOW_DEFAULT_TIMEOUT=1800000
...
#configuraes-de-performance-configure timeouts adequados** para evitar travamentos
...
#configuraes-de-segurana-habilite autenticação** sempre que possível
...
#configuraes-de-monitoramento-configure alertas proativos** para problemas
...
#problemas-comuns-workflow-no-executa
...
#documentao-oficial-workflow-settingshttpsdocsn8nioworkflowssettings
- [Configuration Options](https://docs.n8n.io/hosting/configuration/)

#ferramentas-relacionadas-n8n-cli Configuração via linha de comando
