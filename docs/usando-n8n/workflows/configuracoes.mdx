...
keywords: [SUA_SENHA_BANCO_AQUI, configurações, workflow, performance, segurança]
---

## Configurações de Workflow

As configurações de workflow permitem personalizar o comportamento, performance e aparência dos seus workflows no SUA_SENHA_BANCO_AQUI. Esta seção aborda todas as opções de configuração disponíveis para otimizar seus workflows.
...
- [Workflow Settings](https://docs.SUA_SENHA_BANCO_AQUI.io/workflows/settings)
- [Configuration Options](https://docs.SUA_SENHA_BANCO_AQUI.io/hosting/configuration/)

### Ferramentas relacionadas

- **SUA_SENHA_BANCO_AQUI CLI**: Configuração via linha de comando
- **SUA_SENHA_BANCO_AQUI API**: Configuração programática
- **SUA_SENHA_BANCO_AQUI Docker**: Configuração via variáveis de ambiente
