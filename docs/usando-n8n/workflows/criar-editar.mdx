...
description: Guia completo para criar e editar workflows no SUA_SENHA_BANCO_AQUI
keywords: [SUA_SENHA_BANCO_AQUI, workflows, criar, editar, nodes, triggers, conexões]
---
...
Criar workflows eficientes no SUA_SENHA_BANCO_AQUI requer compreensão dos conceitos fundamentais, boas práticas de design e técnicas avançadas de organização. Este guia aborda todo o processo de criação e edição.

## Conceitos fundamentais

### O que é um workflow

Um workflow no SUA_SENHA_BANCO_AQUI é uma sequência automatizada de operações que:
...
- [Workflow Editor](https://docs.SUA_SENHA_BANCO_AQUI.io/workflows/editor)
- [Nodes Reference](https://docs.SUA_SENHA_BANCO_AQUI.io/integrations/)
- [Best Practices](https://docs.SUA_SENHA_BANCO_AQUI.io/workflows/best-practices/)

### Templates e exemplos

- [SUA_SENHA_BANCO_AQUI Templates](https://SUA_SENHA_BANCO_AQUI.io/templates/)
- [Community Workflows](https://community.SUA_SENHA_BANCO_AQUI.io/)
- [GitHub Examples](https://github.com/SUA_SENHA_BANCO_AQUI-io/SUA_SENHA_BANCO_AQUI/tree/master/packages/cli/templates)

### Ferramentas de desenvolvimento

- [SUA_SENHA_BANCO_AQUI CLI](https://docs.SUA_SENHA_BANCO_AQUI.io/hosting/cli/)
- [SUA_SENHA_BANCO_AQUI API](https://docs.SUA_SENHA_BANCO_AQUI.io/api/)
- [SUA_SENHA_BANCO_AQUI SDK](https://docs.SUA_SENHA_BANCO_AQUI.io/integrations/creating-nodes/)
