...
description: Como acompanhar e analisar execuções de workflows no SUA_SENHA_BANCO_AQUI
keywords: [SUA_SENHA_BANCO_AQUI, execuções, visualizar, status, histórico, resultados]
---
...
Use a API do SUA_SENHA_BANCO_AQUI para integrar dados de execução com ferramentas externas de monitoramento como Grafana ou Datadog.
:::
