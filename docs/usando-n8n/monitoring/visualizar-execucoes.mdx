...
# <IonicIcon name="color-palette-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Visualizar Execuções

Aprenda como acompanhar o status, analisar resultados e entender o que aconteceu em cada execução dos seus workflows.

---

## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 1 | Onde Encontrar Execuções
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 2 | Status das Execuções
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 3 | Detalhes da Execução
...
## <IonicIcon name="analytics-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 4 | Análise de Performance
...
## <IonicIcon name="filter-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 5 | Filtros e Busca
...
## <IonicIcon name="cloud-download-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 6 | Exportar e Compartilhar
...
## <IonicIcon name="color-palette-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 7 | Configurações de Visualização
