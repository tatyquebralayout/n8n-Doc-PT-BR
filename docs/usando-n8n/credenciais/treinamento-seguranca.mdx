...
# <IonicIcon name="school-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Treinamento de Segurança
...
## <IonicIcon name="library-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Programa de Treinamento
...
## <IonicIcon name="book-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Módulos de Treinamento
...
## <IonicIcon name="analytics-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Avaliações e Métricas
...
**<IonicIcon name="school-outline" style={{ fontSize: '16px', color: '#ea4b71' }} /> Pronto para treinar? Comece desenvolvendo seu programa de conscientização em segurança!**
