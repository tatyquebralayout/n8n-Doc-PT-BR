...
# <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Compartilhamento de Credenciais
...
## <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 1 | Por que Compartilhar Credenciais?
...
## <IonicIcon name="key-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 2 | Configurando Compartilhamento
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 3 | Cenários de Uso
...
## <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 4 | Boas Práticas de Segurança
...
## <IonicIcon name="key-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 5 | Configurações Avançadas
...
## <IonicIcon name="bug-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 6 | Troubleshooting
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 7 | Próximos passos
