...
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração do Embed
...
## <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Parâmetros de Configuração
...
## <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Permissões e Controle de Acesso
...
## <IonicIcon name="color-palette-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Customização Visual
...
## <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Checklist de Configuração
