...
- **[Configuração do Embed](/embed/implementacao/configuracao)** - Parâmetros essenciais, permissões, customização visual, integração com autenticação e exemplos práticos.

- **[Implantação do Embed](/embed/implementacao/implantacao)** - Checklist de segurança, SSO, performance, monitoramento, exemplos de deployment e troubleshooting.
