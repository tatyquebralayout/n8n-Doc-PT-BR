...
- [Checklist de pré-requisitos para embed n8n](/embed/preparacao/prerequisitos)
- [Guia de configuração e implantação do embed](/embed/implementacao/configuracao)
- [Como gerenciar workflows integrados e white-labelling](/embed/gerenciamento/gerenciar-workflows)
...
1. **Revise os [Pré-requisitos](/embed/preparacao/prerequisitos)** para entender os requisitos
2. **Configure a [Implementação](/embed/implementacao/configuracao)** para começar
3. **Aprenda sobre [Gerenciamento](/embed/gerenciamento/gerenciar-workflows)** para administrar
