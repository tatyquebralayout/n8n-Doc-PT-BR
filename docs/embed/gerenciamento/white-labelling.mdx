...
# <IonicIcon name="document-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> White Labelling
...
## <IonicIcon name="color-palette-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Personalização de Tema
...
```bash
# <IonicIcon name="color-palette-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configurações básicas de tema
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Branding e Logos
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configurar logo principal
...
# <IonicIcon name="color-palette-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Logo para tema escuro
...
```bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configurar favicon
...
# <IonicIcon name="document-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Ícones para PWA
...
```bash
# <IonicIcon name="document-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Textos customizados
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> CSS Customizado
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Domínio Customizado
...
```nginx
# <IonicIcon name="sparkles-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> /etc/nginx/sites-available/n8n-custom
server {
    listen 80;
...
```yaml
# <IonicIcon name="cloud-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> docker-compose.yml com domínio customizado
version: '3.8'
services:
  nginx:
    image: nginx:alpine
...
```bash
#!/bin/bash
# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> setup-ssl.sh

DOMAIN="automação.suaempresa.com"
EMAIL="admin@suaempresa.com"

# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Instalar Certbot
sudo apt update
sudo apt install certbot python3-certbot-nginx

# <IonicIcon name="document-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Obter certificado
sudo certbot --nginx -d $DOMAIN --email $EMAIL --agree-tos --non-interactive

# <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configurar renovação automática
sudo crontab -e
# <IonicIcon name="document-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Adicionar linha:
# <IonicIcon name="grid-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 0 12 * * * /usr/bin/certbot renew --quiet
```

#### **Headers de Segurança**

```nginx
# <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> security-headers.conf
...
# <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Outros headers de segurança
add_header X-Frame-Options "SAMEORIGIN" always;
add_header X-Content-Type-Options "nosniff" always;
add_header X-XSS-Protection "1; mode=block" always;
...
## <IonicIcon name="git-network-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Integração Visual
