...
# <IonicIcon name="grid-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Pré-requisitos para Embed
...
## <IonicIcon name="folder-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Infraestrutura Recomendada
...
## <IonicIcon name="color-palette-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Domínios Permitidos e CORS
...
## <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Segurança e Planejamento
...
## <IonicIcon name="school-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Planejamento de Recursos
...
## <IonicIcon name="grid-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Checklist de Pré-requisitos
