...
# <IonicIcon name="code-slash-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Visão Geral - Nodes de IA

Esta seção oferece uma visão geral sobre os **principais nodes de IA** disponíveis no n8n.

## <IonicIcon name="code-slash-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> O que são os Nodes de IA?
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Como navegar nesta seção?
