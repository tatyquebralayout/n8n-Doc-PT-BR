...
## <IonicIcon name="play-circle-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Tutorial de IA {#tutorial-de-ia}

- **[Tutorial de IA](./tutorial-ai)** – Introdução prática aos conceitos de IA no n8n

---

## <IonicIcon name="library-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> LangChain {#langchain}

- **[Visão Geral do LangChain](./langchain-overview)** – Framework para aplicações de IA

---

## <IonicIcon name="cube-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Nodes de IA {#nodes-de-ia}
...
## <IonicIcon name="bulb-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Exemplos e Casos {#exemplos-e-casos}
