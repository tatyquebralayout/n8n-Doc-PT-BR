...
graph TD
    ...
    B -->|Processa| C[<ion-icon name="analytics-outline"></ion-icon> Analise Sentimento<br/>OpenAI GPT]
...
```mermaid
graph TD
    A[<ion-icon name="chatbubble-ellipses-outline"></ion-icon> Webhook<br/>Recebe Mensagem] -->|Processa| B[<ion-icon name="analytics-outline"></ion-icon> Analise Sentimento<br/>OpenAI GPT]
