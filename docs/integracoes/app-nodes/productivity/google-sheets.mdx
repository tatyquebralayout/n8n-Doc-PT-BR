...
# <IonicIcon name="document-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Google Sheets
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> O que você pode fazer
...
## <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Configuração Rápida
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Operações Disponíveis
...
## <IonicIcon name="bulb-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Casos de Uso Populares
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Dicas e Truques
...
## <IonicIcon name="link-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Links Úteis
