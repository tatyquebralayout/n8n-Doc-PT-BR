...
- **[Gatilhos de App](/integracoes/trigger-nodes/app-triggers)** - Triggers de aplicações como Gmail
 - **[Code Node](/integracoes/builtin-nodes/core-nodes/code)** - Processamento customizado de emails
- **[Database Nodes](../../builtin-nodes/data-processing/split-in-batches.mdx)** - Armazenamento de dados de email
