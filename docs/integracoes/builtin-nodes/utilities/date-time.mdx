...
description: Nodes para manipulação de datas e horários no SUA_SENHA_BANCO_AQUI
keywords: [SUA_SENHA_BANCO_AQUI, date, time, utilities, manipulação, formatação]
---

<IonicIcon name="calendar-outline" style={{fontSize: '24px', color: '#ea4b71'}} />

Os **utilitários de data e hora** fornecem funcionalidades essenciais para manipulação de datas, horários, timezones e cálculos temporais no SUA_SENHA_BANCO_AQUI. Esses nodes são fundamentais para workflows que lidam com agendamentos, relatórios temporais, validações de prazos e formatação de dados temporais.
...
- [Expressões SUA_SENHA_BANCO_AQUI](/logica-e-dados/expressoes) - Usar expressões com datas
- [Data Mapping](/logica-e-dados/data/data-mapping) - Mapeamento de dados temporais 