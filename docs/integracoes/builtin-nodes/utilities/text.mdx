...
description: Nodes para processamento e manipulação de texto no SUA_SENHA_BANCO_AQUI
keywords: [SUA_SENHA_BANCO_AQUI, text, utilities, processamento, manipulação, strings]
---

<IonicIcon name="text-outline" style={{fontSize: '24px', color: '#ea4b71'}} />

Os **utilitários de texto** fornecem funcionalidades essenciais para manipulação, formatação, validação e transformação de strings no SUA_SENHA_BANCO_AQUI. Esses nodes são fundamentais para workflows que lidam com limpeza de dados, normalização de texto, extração de informações e formatação de conteúdo.
...
- [Expressões SUA_SENHA_BANCO_AQUI](/logica-e-dados/expressoes) - Usar expressões com texto
