...
#ionicicon-namecode-slash-outline-style-fontsize-24px color: '#cor-ea4b71-function-node
...
#id-1-function-code-javascript Estrutura básica
return {
  json: {
...
#id-2-variveis-disponveis-javascript Dados do item atual
...
#exemplo-1-transformao-simples-de Dados**
...
#exemplo-4-clculos-matemticos-funo
...
#exemplo-6-condicionais-e-lgica
...
#ionicicon-namesettings-outline-style-fontsize-24px color: '#cor-ea4b71-operaes-avanadas

#manipulao-de-arrays-funo-javascript
...
#manipulao-de-objetos-funo-javascript
// Mesclar objetos
const dadosBasicos = {
  id: $json.id,
  nome: $json.nome,
...
#validaes-complexas-funo-javascript Validar CPF
...
#ionicicon-namespeedometer-outline-style-fontsize-24px color: '#cor-ea4b71-performance-vs Code Node**

#quando-usar-function-node ✅ Operações simples por item
- ✅ Transformações básicas de dados
- ✅ Validações rápidas
- ✅ Formatação de campos
- ✅ Cálculos matemáticos simples

#quando-usar-code-node ✅ Lógica complexa envolvendo múltiplos itens
- ✅ Agregações e estatísticas
- ✅ Integração com APIs externas
- ✅ Processamento em lote
- ✅ Manipulação de arrays complexos

#comparao-de-performance-javascript Function Node - Mais rápido para operações simples
return {
  json: {
    ...$json,
    processado: true,
...
#limitaes-do-function-node **Escopo isolado**: Cada item é processado independentemente
...
#boas-prticas-javascript Bom: Código simples e direto
return {
  json: {
    ...$json,
    processado: true
...
#tratamento-de-erros-javascript Tratamento básico de erros
try {
