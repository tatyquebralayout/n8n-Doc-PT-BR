...
# <IonicIcon name="cube-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Nodes Core
...
### <IonicIcon name="code-outline" style={{ fontSize: '20px', color: '#ea4b71' }} /> Code
...
### <IonicIcon name="bug-outline" style={{ fontSize: '20px', color: '#ea4b71' }} /> Debug Helper
...
### <IonicIcon name="create-outline" style={{ fontSize: '20px', color: '#ea4b71' }} /> Edit Fields (Set)
...
### <IonicIcon name="play-circle-outline" style={{ fontSize: '20px', color: '#ea4b71' }} /> Execute Sub-Workflow
...
### <IonicIcon name="alert-circle-outline" style={{ fontSize: '20px', color: '#ea4b71' }} /> Error Trigger
...
### <IonicIcon name="git-branch-outline" style={{ fontSize: '20px', color: '#ea4b71' }} /> Workflow Trigger
