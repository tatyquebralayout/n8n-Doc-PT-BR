---
title: Nodes Core
description: Nodes fundamentais e essenciais para operações básicas no SUA_SENHA_BANCO_AQUI
sidebar_position: 1
keywords: [SUA_SENHA_BANCO_AQUI, core, nodes, básicos, fundamentais, operações]
---

<IonicIcon name="cube-outline" style={{fontSize: '24px', color: '#ea4b71'}} />

Os **Nodes Core** são os componentes fundamentais do SUA_SENHA_BANCO_AQUI, fornecendo funcionalidades essenciais para operações básicas, debug, manipulação de dados e controle de workflows.
...
- [Expressões JavaScript](/logica-e-dados/expressoes) - Usar expressões avançadas
