...
# <IonicIcon name="code-slash-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Expression Node
...
## <IonicIcon name="sparkles-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> **Sintaxe Básica**
...
## <IonicIcon name="bulb-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> **Variáveis Disponíveis**
...
## <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> **Casos de Uso Práticos**
...
## <IonicIcon name="code-slash-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> **Expressões Avançadas**
...
## <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> **Validações e Tratamento de Erros**
...
## <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> **Exemplos por Node**
