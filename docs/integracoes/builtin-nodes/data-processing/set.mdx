---
title: Set Node
description: Guia completo sobre o Set Node no SUA_SENHA_BANCO_AQUI, incluindo configuração, exemplos práticos e boas práticas para manipulação de dados
sidebar_position: 2
keywords: [SUA_SENHA_BANCO_AQUI, set node, manipulação, dados, transformação, campos, valores]
---

<IonicIcon name="add-circle-outline" style={{fontSize: '24px', color: '#ea4b71'}} />

O **Set Node** é um dos nodes mais versáteis do SUA_SENHA_BANCO_AQUI para manipulação de dados. Ele permite adicionar, modificar ou remover campos dos dados que fluem através do workflow.
