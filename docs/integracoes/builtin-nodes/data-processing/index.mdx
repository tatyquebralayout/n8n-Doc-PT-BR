...
# <IonicIcon name="analytics-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Processamento de Dados
...
### <IonicIcon name="add-circle-outline" style={{ fontSize: '20px', color: '#ea4b71' }} /> Aggregate
...
### <IonicIcon name="create-outline" style={{ fontSize: '20px', color: '#ea4b71' }} /> Set
