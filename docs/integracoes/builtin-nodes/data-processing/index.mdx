...
description: Nodes para manipular, transformar e processar dados no SUA_SENHA_BANCO_AQUI
sidebar_position: 1
keywords: [SUA_SENHA_BANCO_AQUI, dados, processamento, transformação, manipulação, agregação]
---

<IonicIcon name="analytics-outline" style={{fontSize: '24px', color: '#ea4b71'}} />

Os nodes de **Processamento de Dados** são essenciais para manipular, transformar e organizar informações no SUA_SENHA_BANCO_AQUI. Eles permitem que você prepare dados para uso em workflows, agrupe informações relacionadas e crie estruturas de dados otimizadas.
...
No SUA_SENHA_BANCO_AQUI, os dados são organizados em **items** (itens), onde cada item representa uma entrada de dados. Cada item pode conter múltiplos campos com diferentes tipos de dados.
...
O SUA_SENHA_BANCO_AQUI suporta diversos tipos de dados:
