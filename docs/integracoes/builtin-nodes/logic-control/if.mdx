---
title: Node If
description: Aprenda a usar o node If no n8n para criar condições e tomar decisões baseadas em dados
sidebar_position: 1
...
O **node If** é um dos componentes mais importantes do n8n para controle de fluxo. Ele permite criar condições e tomar decisões baseadas em dados, direcionando o workflow por diferentes caminhos.
