...
# <IonicIcon name="git-branch-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Controle de Lógica
...
### <IonicIcon name="checkmark-circle-outline" style={{ fontSize: '20px', color: '#ea4b71' }} /> If
...
### <IonicIcon name="git-network-outline" style={{ fontSize: '20px', color: '#ea4b71' }} /> Switch
...
### <IonicIcon name="git-merge-outline" style={{ fontSize: '20px', color: '#ea4b71' }} /> Merge
