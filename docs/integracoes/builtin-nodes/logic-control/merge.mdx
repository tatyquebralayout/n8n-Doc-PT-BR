---
title: Node Merge
description: Aprenda a usar o node Merge no n8n para combinar dados de múltiplas fontes
sidebar_position: 3
...
O **node Merge** é uma ferramenta essencial do n8n para combinar dados de múltiplas fontes. Ele permite unir informações de diferentes caminhos do workflow, criando datasets consolidados e enriquecidos.
