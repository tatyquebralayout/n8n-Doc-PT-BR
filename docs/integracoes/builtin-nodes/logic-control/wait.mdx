---
title: Node Wait
description: Aprenda a usar o node Wait no SUA_SENHA_BANCO_AQUI para adicionar pausas e delays em workflows
sidebar_position: 4
keywords: [SUA_SENHA_BANCO_AQUI, wait node, delay, pausa, tempo, automação, workflow]
---
