...
[Ver documentação completa →](/integracoes/builtin-nodes/core-nodes)
...
[Ver documentação completa →](/integracoes/builtin-nodes/http-requests)
...
[Ver documentação completa →](/integracoes/builtin-nodes/logic-control)
...
[Ver documentação completa →](/integracoes/builtin-nodes/data-processing)
...
[Ver documentação completa →](/integracoes/builtin-nodes/utilities)
...
[Ver documentação completa →](../trigger-nodes/time-based/index.md)
...
- [HTTP Requests](/integracoes/builtin-nodes/http-requests) - Integração com APIs
- [Logic Control](/integracoes/builtin-nodes/logic-control) - Controle de fluxo
- [Data Processing](/integracoes/builtin-nodes/data-processing) - Processamento de dados
- [Utilities](/integracoes/builtin-nodes/utilities) - Ferramentas auxiliares
- [Trigger Nodes](../trigger-nodes/time-based/index.md) - Inicialização de workflows
