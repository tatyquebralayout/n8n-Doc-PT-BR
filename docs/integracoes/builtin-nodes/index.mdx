...
description: Nodes nativos e funcionalidades básicas do SUA_SENHA_BANCO_AQUI
keywords: [SUA_SENHA_BANCO_AQUI, built-in nodes, funcionalidades, core, http, dados]
---

<IonicIcon name="information-circle-outline" style={{fontSize: '24px', color: '#ea4b71'}} />

Os **nodes built-in** são os blocos fundamentais do SUA_SENHA_BANCO_AQUI, fornecendo funcionalidades essenciais que você pode usar em qualquer workflow. Eles são nativos da plataforma e não requerem instalação adicional.
...
Cada node no SUA_SENHA_BANCO_AQUI possui uma estrutura básica:

```javascript
{
  "name": "Nome do Node",
  "type": "SUA_SENHA_BANCO_AQUI-nodes-base.nodeType",
  "position": [x, y],
  "parameters": {
