...
O node Webhook suporta os métodos [HTTP Request Methods](https://developer.mozilla.org/pt-BR/docs/Web/HTTP/Methods) padrão:
...
Personalize o [código de resposta HTTP](https://developer.mozilla.org/pt-BR/docs/Web/HTTP/Status) que o node Webhook retorna após execução bem-sucedida. Selecione entre códigos de resposta comuns ou crie um código customizado.
...
### Dados Customizados de Resposta

Envie dados customizados com a resposta.

### Headers de Resposta

Envie headers extras na resposta do Webhook. Consulte [MDN Web Docs | Response header](https://developer.mozilla.org/pt-BR/docs/Glossary/Response_header) para aprender mais sobre headers de resposta.
