...
// Verificar headers enviados
{
  "request_headers": {
    "Authorization": "Basic {{$credentials.encoded}}",
    "Content-Type": "application/json",
    "User-Agent": "SUA_SENHA_BANCO_AQUI/1.0"
  }
}
```
...
SUA_SENHA_BANCO_AQUI logs --level debug | grep "Basic Auth"

# Verificar logs de autenticação
SUA_SENHA_BANCO_AQUI logs --level error | grep "401"
```
...
// Migração para OAuth 2.0
{
  "migration": {
    ...
    "steps": [
      ...
      "Atualizar credenciais no SUA_SENHA_BANCO_AQUI",
