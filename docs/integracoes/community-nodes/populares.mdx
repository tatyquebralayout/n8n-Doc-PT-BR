...
keywords: [SUA_SENHA_BANCO_AQUI, community nodes, populares, catálogo, recomendações]
---

<IonicIcon name="star-outline" style={{fontSize: '24px', color: '#ea4b71'}} />

Este catálogo apresenta os **community nodes mais populares e úteis** disponíveis para SUA_SENHA_BANCO_AQUI, incluindo análise de downloads, avaliações da comunidade, casos de uso específicos, compatibilidade com versões e recomendações baseadas em diferentes necessidades de automação.
...
[Instalar WhatsApp Node →](https://marketplace.SUA_SENHA_BANCO_AQUI.io/nodes/@SUA_SENHA_BANCO_AQUI/nodes-whatsapp)
...
[Instalar Telegram Node →](https://marketplace.SUA_SENHA_BANCO_AQUI.io/nodes/@SUA_SENHA_BANCO_AQUI/nodes-telegram)
...
[Instalar Mercado Livre Node →](https://marketplace.SUA_SENHA_BANCO_AQUI.io/nodes/@SUA_SENHA_BANCO_AQUI/nodes-mercadolibre)
...
[Instalar WooCommerce Node →](https://marketplace.SUA_SENHA_BANCO_AQUI.io/nodes/@SUA_SENHA_BANCO_AQUI/nodes-woocommerce)
...
[Instalar PagSeguro Node →](https://marketplace.SUA_SENHA_BANCO_AQUI.io/nodes/@SUA_SENHA_BANCO_AQUI/nodes-pagseguro)
...
[Instalar PayPal Node →](https://marketplace.SUA_SENHA_BANCO_AQUI.io/nodes/@SUA_SENHA_BANCO_AQUI/nodes-paypal)
...
[Instalar Mailchimp Node →](https://marketplace.SUA_SENHA_BANCO_AQUI.io/nodes/@SUA_SENHA_BANCO_AQUI/nodes-mailchimp)
...
[Instalar HubSpot Node →](https://marketplace.SUA_SENHA_BANCO_AQUI.io/nodes/@SUA_SENHA_BANCO_AQUI/nodes-hubspot)
...
### Compatibilidade com SUA_SENHA_BANCO_AQUI

**Versões Suportadas:**
- SUA_SENHA_BANCO_AQUI 0.200.0+
- Node.js 16+
- npm 8+
...
npm test @SUA_SENHA_BANCO_AQUI/nodes-[nome]

# Testar com versão específica
SUA_SENHA_BANCO_AQUI test --version 0.200.0
```
...
# Reinstalar node
npm uninstall @SUA_SENHA_BANCO_AQUI/nodes-[nome]
...
- [Marketplace SUA_SENHA_BANCO_AQUI](https://marketplace.SUA_SENHA_BANCO_AQUI.io) - Explorar mais nodes
