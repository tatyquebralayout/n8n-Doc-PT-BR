...
keywords: [SUA_SENHA_BANCO_AQUI, community nodes, custom, desenvolvimento, npm]
---

<IonicIcon name="people-outline" style={{fontSize: '24px', color: '#ea4b71'}} />

Os **Community Nodes** representam o ecossistema de integrações desenvolvidas pela comunidade global do SUA_SENHA_BANCO_AQUI. Esses nodes expandem significativamente as capacidades da plataforma, oferecendo integrações personalizadas para casos de uso específicos que não são cobertos pelos nodes nativos.
...
- **Extendem funcionalidades** do SUA_SENHA_BANCO_AQUI com integrações específicas
...
**Nodes Oficiais:**
- Desenvolvidos pela equipe SUA_SENHA_BANCO_AQUI
...
[Explorar Marketplace →](https://marketplace.SUA_SENHA_BANCO_AQUI.io)
...
[Ver no GitHub →](https://github.com/SUA_SENHA_BANCO_AQUI-io/SUA_SENHA_BANCO_AQUI-nodes-starter-template)
...
- Compatibilidade com versões SUA_SENHA_BANCO_AQUI
...
4. **Mantenha compatibilidade** - Atualize conforme novas versões do SUA_SENHA_BANCO_AQUI
...
- Confirme compatibilidade com versão do SUA_SENHA_BANCO_AQUI
- Reinicie o servidor SUA_SENHA_BANCO_AQUI
