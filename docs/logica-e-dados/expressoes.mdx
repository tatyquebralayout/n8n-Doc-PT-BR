...
#ionicicon-namecode-outline-style-fontsize-24px color: '#cor-ea4b71-expresses-n8n
...
#o-que-so-expresses-expresses são trechos de código JavaScript que:
...
#sintaxe-bsica-as-expresses-no n8n usam a sintaxe `{{ }}`:
...
#cor-dados-do-item-atual-para acessar dados do item atual:
...
#cor-dados-de-nodes-especficos-para acessar dados de nodes anteriores:
...
#data-atual-javascript-data atual em ISO
{{ $now.toISOString() }}
...
#clculos-com-datas-javascript Adicionar dias
...
#formatao-de-datas-javascript Formato brasileiro
...
#operaes-bsicas-javascript-concatenar strings
...
#busca-e-substituio-javascript Verificar se contém texto
...
#validao-de-texto-javascript Verificar se está vazio
{{ $json.texto.length === 0 }}
...
#operaes-bsicas-javascript-soma
...
#funes-matemticas-javascript-arredondar
...
#clculos-financeiros-javascript-calcular desconto
...
#manipulao-de-arrays-javascript Tamanho do array
{{ $json.itens.length }}
...
#manipulao-de-objetos-javascript Chaves do objeto
{{ Object.keys($json) }}
...
#operadores-de-comparao-javascript Igualdade
{{ $json.valor === 100 }}
...
#operadores-lgicos-javascript-e lógico
...
#operador-ternrio-javascript-condio simples
...
#funes-simples-javascript-funo para formatar CPF
{{ (function(cpf) {
...
#funes-com-mltiplos-parmetros-javascript
...
#exemplo-2-clculos-financeiros-javascript
...
#exemplo-4-lgica-condicional-javascript
...
#id-1-performance-javascript Bom: Cache de valores calculados
{{ (function() {
...
#id-2-legibilidade-javascript Bom: Expressões claras
...
#id-3-tratamento-de-erros-javascript
...
#id-4-reutilizao-javascript Bom: Funções reutilizáveis
{{ (function(valor, desconto) {
  return valor * (1 - desconto / 100);
})($json.valor, $json.desconto) }}
...
#funes-de-string-javascript Verificar se string está vazia
...
#funes-de-array-javascript Verificar se array contém valor
...
#funes-de-data-javascript Verificar se é fim de semana
...
#prximos-passos-http-requestintegracoesbuiltin-nodeshttp-requestshttp-request - Usar expressões em requisições
