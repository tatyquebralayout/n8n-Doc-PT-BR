...
:::info
<IonicIcon name="cube-outline" style={{ fontSize: '18px', color: '#ea4b71' }} />
...
:::info
<IonicIcon name="cube-outline" style={{ fontSize: '18px', color: '#ea4b71' }} />
**Veja o guia completo:** [Estrutura de Dados no n8n](./estrutura-dados) — padrão, exemplos, boas práticas e diagrama visual.
:::
...
## <IonicIcon name="document-text-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Dados {#dados}
...
## <IonicIcon name="git-branch-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Lógica de Fluxo {#logica-de-fluxo}
...
## <IonicIcon name="git-network-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Conexões {#conexoes}
...
## <IonicIcon name="repeat-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Processamento de Itens e Fluxo de Dados nos Nós
...
## <IonicIcon name="trending-up-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Técnicas Avançadas {#tecnicas-avancadas}
...
## <IonicIcon name="bug-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Debugging {#debugging}
