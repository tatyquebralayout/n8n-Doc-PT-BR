...
# <IonicIcon name="swap-horizontal-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Transformando Dados
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Quando Transformar Dados
...
## <IonicIcon name="grid-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Nodes de Transformação
...
## <IonicIcon name="code-slash-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Transformação com Code Node
...
## <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Transformação com Set Node
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Casos de Uso Comuns
