...
#ionicicon-nameanalytics-outline-style-fontsize-24px color: '#cor-ea4b71-agregaes-e Estatísticas
...
#ionicicon-nameanalytics-outline-style-fontsize-24px color: '#cor-ea4b71-1 Estatísticas Básicas

#mtricas-de-tendncia-central-calcular médias, medianas e modas:**
...
#medidas-de-disperso-calcular-varincia e desvio padrão:**
...
#ionicicon-namepeople-outline-style-fontsize-24px color: '#cor-ea4b71-2 Agregações por Grupo

#agrupar-por-categoria-exemplo-anlise de vendas por categoria:**
...
#agregaes-temporais-anlise-por-perodo
...
#ionicicon-nameanalytics-outline-style-fontsize-24px color: '#cor-ea4b71-3 Análises de Distribuição

#distribuio-de-frequncias-criar-histogramas e distribuições:**
...
#percentis-e-quartis-calcular-percentis para análise:**
...
#ionicicon-nameanalytics-outline-style-fontsize-24px color: '#cor-ea4b71-4 Análises de Tendência

#crescimento-e-decrescimento-calcular-taxas de crescimento:**
...
#sazonalidade-identificar-padres-sazonais-javascript
...
#ionicicon-nameanalytics-outline-style-fontsize-24px color: '#cor-ea4b71-5 Análises de Clientes

#segmentao-rfm-anlise-rfm-recency Frequency, Monetary):**
...
#ranking-e-top-performers-identificar melhores clientes:**
...
#ionicicon-nameanalytics-outline-style-fontsize-24px color: '#cor-ea4b71-6 Métricas de Performance

#kpis-de-negcio-calcular-indicadores-chave
...
#anlise-de-churn-calcular-taxa de abandono:**
...
#ionicicon-nameanalytics-outline-style-fontsize-24px color: '#cor-ea4b71-7 Relatórios Automatizados

#resumo-executivo-gerar-relatrio-resumido
