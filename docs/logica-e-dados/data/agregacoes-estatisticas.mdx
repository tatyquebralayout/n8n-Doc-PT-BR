...
# <IonicIcon name="analytics-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Agregações e Estatísticas
...
## <IonicIcon name="analytics-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 1 | Estatísticas Básicas
...
## <IonicIcon name="people-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 2 | Agregações por Grupo
...
## <IonicIcon name="analytics-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 3 | Análises de Distribuição
...
## <IonicIcon name="analytics-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 4 | Análises de Tendência
...
## <IonicIcon name="analytics-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 5 | Análises de Clientes
...
## <IonicIcon name="analytics-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 6 | Métricas de Performance
...
## <IonicIcon name="analytics-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 7 | Relatórios Automatizados
