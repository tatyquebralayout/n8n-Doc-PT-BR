...
# <IonicIcon name="git-network-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Fluxo de Dados Dentro dos Nodes
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Como os Itens Fluem
...
## <IonicIcon name="code-slash-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Nodes com Comportamento Especial
...
## <IonicIcon name="grid-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Exemplos de Fluxo
