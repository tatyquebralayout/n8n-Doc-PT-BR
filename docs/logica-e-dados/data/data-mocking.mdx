...
description: Técnicas para gerar dados sintéticos realistas para testes de workflows no n8n
keywords: [n8n, dados de teste, mocking, dados sintéticos, testes, desenvolvimento]
---
...
3. **[Otimização de Performance](./data-structure)** - Melhore eficiência
