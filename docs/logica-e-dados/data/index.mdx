...
## <IonicIcon name="school-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Padrões de Processamento
...
**<IonicIcon name="analytics-outline" style={{ fontSize: '16px', color: '#ea4b71' }} /> Transforme dados em insights valiosos!**
