...
sidebar_position: 6
title: Debugging
description: Técnicas e ferramentas para debugging de workflows no n8n
...
1. **[Error Handling](./error-handling)** - Tratamento robusto de erros
2. **[Data Pinning](../data/data-pinning)** - Desenvolvimento com dados fixos
3. **[Performance Optimization](../data/otimizacao-performance)** - Otimizar workflows
...
- **[Execution Order](./execution-order)** - Ordem de execução
