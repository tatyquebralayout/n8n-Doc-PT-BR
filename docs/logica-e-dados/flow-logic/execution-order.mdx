...
# <IonicIcon name="play-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Ordem de Execução
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Como a Ordem é Determinada
...
## <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Tipos de Conexões
...
## <IonicIcon name="code-slash-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Exemplos de Ordem de Execução
