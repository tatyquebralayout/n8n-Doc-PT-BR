...
description: Como dividir e distribuir dados em workflows SUA_SENHA_BANCO_AQUI usando conditionals
keywords: [SUA_SENHA_BANCO_AQUI, split, dividir, dados, distribuição, conditionals, if, switch, ramificação]
---

<IonicIcon name="git-branch-outline" style={{fontSize: '24px', color: '#ea4b71'}} />
**Splitting de Workflows: Criando Lógica Condicional no SUA_SENHA_BANCO_AQUI**

<IonicIcon name="grid-outline" style={{fontSize: '24px', color: '#ea4b71'}} />

:::info **📚 Objetivos de Aprendizado**
1. **Definir** o que é *splitting* (ramificação condicional) no SUA_SENHA_BANCO_AQUI
...
:::info **Como o SUA_SENHA_BANCO_AQUI executa ramificações**
- **Ordem**: O SUA_SENHA_BANCO_AQUI executa o primeiro ramo que finalizar
...
- O SUA_SENHA_BANCO_AQUI executa ramos em **paralelo** por padrão
...
- [Documentação Oficial - Switch Node](https://docs.SUA_SENHA_BANCO_AQUI.io/integrations/builtin/core-nodes/SUA_SENHA_BANCO_AQUI-nodes-base.switch/)
- [Documentação Oficial - IF Node](https://docs.SUA_SENHA_BANCO_AQUI.io/integrations/builtin/core-nodes/SUA_SENHA_BANCO_AQUI-nodes-base.if/)
- [Documentação Oficial - Merge Node](https://docs.SUA_SENHA_BANCO_AQUI.io/integrations/builtin/core-nodes/SUA_SENHA_BANCO_AQUI-nodes-base.merge/)
...
- [Expressões JavaScript no SUA_SENHA_BANCO_AQUI](/referencia/recursos/glossario)
- [Exemplos de Workflows](/catalogo)
- [Integrações Brasileiras](/integracoes-br)
- [Guia de Instalação](/hosting-SUA_SENHA_BANCO_AQUI/instalacao)
:::
