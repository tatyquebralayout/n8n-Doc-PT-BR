...
| **[Switch](../../integracoes/builtin-nodes/logic-control/switch)** | Seleção multicondicional | `Case n`, `Default` | Dois modos: **Rules** (comparação direta) ou **Expression** ([lógica JavaScript](../../referencia/recursos/glossario.md)) |
...
*Dica*: Use [Switch aninhados](../../integracoes/builtin-nodes/logic-control/wait.mdx) e considere múltiplas condições simultâneas.
:::
...
- [Exemplos de Workflows](../../catalogo/servicos-brasileiros.mdx)
- [Integrações Brasileiras](../../integracoes-br/financeiro/compliance-fiscal.md)
- [Guia de Instalação](../../primeiros-passos/instalacao.mdx)
:::
