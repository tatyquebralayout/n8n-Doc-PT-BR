...
# <IonicIcon name="document-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Como Participar
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Compartilhe Seu Conteúdo
...
## <IonicIcon name="people-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Contribua com a Comunidade
...
## <IonicIcon name="chevron-forward-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Conecte-se Conosco
...
## <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Código de Conduta
