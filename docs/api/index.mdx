...
#api-rest-do-n8n-integrao Programática, Endpoints e Webhooks
...
#ionicicon-namebook-outline-style-fontsize-24px color: '#cor-ea4b71-conceitos#conceitos-viso-geralconceitos Introdução aos conceitos da API
...
#ionicicon-nameconstruct-outline-style-fontsize-24px color: '#cor-ea4b71-ferramentas#ferramentas-viso-geral-das Ferramentas](./ferramentas/)** – Recursos disponíveis
- **[Playground](./ferramentas/playground)** – Teste a API de forma interativa

---

#ionicicon-namedocument-text-outline-style-fontsize-24px color: '#cor-ea4b71-referncia#referencia-viso-geral-da Referência](./referencia/)** – Documentação completa
- **[Referência da API](./referencia/referencia-api)** – Endpoints e parâmetros detalhados

---

#ionicicon-nameserver-outline-style-fontsize-24px color: '#cor-ea4b71-endpoints-principais {#endpoints-principais}

#workflows-get-workflows Listar workflows
- `POST /workflows` – Criar workflow
- `PUT /workflows/{id}` – Atualizar workflow
- `DELETE /workflows/{id}` – Excluir workflow

#execues-get-executions Listar execuções
- `POST /workflows/{id}/trigger` – Executar workflow
- `GET /executions/{id}` – Obter detalhes da execução

#credenciais-get-credentials Listar credenciais
