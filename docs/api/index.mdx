...
- **[Ferramentas](ferramentas/playground.mdx)** – Recursos disponíveis
...
- **[Referência](../referencia/recursos/glossario.md)** – Documentação completa
...
1. **Comece com os [Conceitos](../primeiros-passos/conceitos-fundamentais.mdx)** para entender os fundamentos
2. **Explore as [Ferramentas](ferramentas/playground.mdx)** para recursos práticos
3. **Consulte a [Referência](../referencia/recursos/glossario.md)** para detalhes completos
