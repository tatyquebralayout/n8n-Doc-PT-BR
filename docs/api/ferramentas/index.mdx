...
2. **Consulte a [Referência](../../referencia/recursos/glossario.md)** para documentação completa dos endpoints
3. **Aprenda os [Conceitos](../../primeiros-passos/conceitos-fundamentais.mdx)** para entender os fundamentos da API
