...
2. **Explore os [Conceitos](../../primeiros-passos/conceitos-fundamentais.mdx)** para entender os fundamentos
3. **Teste com as [Ferramentas](../ferramentas/playground.mdx)** para experimentação prática
