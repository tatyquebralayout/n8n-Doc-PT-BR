...
## <IonicIcon name="search-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Buscar Integrações
...
## <IonicIcon name="grid-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Categorias de Integrações

<div className="categories-grid">

<div className="category-card">

### <IonicIcon name="sparkles-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> IA e Machine Learning
...
### <IonicIcon name="chatbubbles-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Comunicação e Chat
...
### <IonicIcon name="analytics-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Análise de Dados e BI
...
### <IonicIcon name="cart-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> E-commerce e Vendas
...
### <IonicIcon name="mail-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Marketing e Email
...
### <IonicIcon name="cloud-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Cloud e Infraestrutura
...
### <IonicIcon name="server-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Bancos de Dados
...
### <IonicIcon name="people-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Produtividade e Colaboração
...
### <IonicIcon name="folder-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Armazenamento e Arquivos
...
### <IonicIcon name="musical-notes-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Mídia e Conteúdo
...
### <IonicIcon name="card-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Financeiro e Pagamentos
...
### <IonicIcon name="flag-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Serviços Brasileiros
...
### <IonicIcon name="construct-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Desenvolvimento e DevOps
...
### <IonicIcon name="trending-up-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Monitoramento e Analytics
...
## <IonicIcon name="star-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Integrações em Destaque

### <IonicIcon name="trophy-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Top 5 Mais Populares
...
## <IonicIcon name="help-circle-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Como Usar as Integrações

### <IonicIcon name="settings-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 1. Configurar Credenciais

1. Acesse **Settings > Credentials**
2. Adicione as credenciais da integração
3. Configure autenticação (API keys, OAuth, etc.)

### <IonicIcon name="add-circle-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 2. Adicionar ao Workflow

1. Arraste o node da integração
2. Configure os parâmetros necessários
3. Teste a conexão

### <IonicIcon name="build-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 3. Personalizar e Automatizar
...
## <IonicIcon name="bulb-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Dicas de Uso
...
> <IonicIcon name="quote-outline" style={{ fontSize: '16px', color: '#6b7280' }} /> **Pronto para integrar?** Escolha uma categoria e comece a automatizar!
>
