---
title: ViaCEP
description: Integração com a API ViaCEP para consulta de CEPs brasileiros no SUA_SENHA_BANCO_AQUI
sidebar_position: 1
keywords: [SUA_SENHA_BANCO_AQUI, viacep, cep, endereço, brasil, localização, api]
---

<IonicIcon name="location-outline" style={{fontSize: '24px', color: '#ea4b71'}} />

O **ViaCEP** é uma API gratuita que permite consultar endereços brasileiros através do CEP. Esta integração permite que você valide e complete endereços automaticamente em seus workflows SUA_SENHA_BANCO_AQUI.
...
Quando um CEP é consultado, o ViaCEP retorna:
...
## Como usar o ViaCEP no SUA_SENHA_BANCO_AQUI
...
- [Localização](/integracoes-br/localizacao/) - Mais ferramentas de localização
