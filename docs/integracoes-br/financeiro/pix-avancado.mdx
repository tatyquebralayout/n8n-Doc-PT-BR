...
# <IonicIcon name="card-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> PIX Avançado
...
## <IonicIcon name="card-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 1 | Tipos de PIX
...
## <IonicIcon name="git-branch-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 2 | Workflows de Pagamento
...
## <IonicIcon name="code-slash-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 3 | APIs de Bancos Brasileiros
...
## <IonicIcon name="shield-checkmark-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 4 | Segurança e Compliance
...
## <IonicIcon name="bulb-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 5 | Casos de Uso Empresariais
...
## <IonicIcon name="analytics-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> 6 | Relatórios e Analytics
