...
# <IonicIcon name="flag-outline" style={{ fontSize: '24px', color: '#ea4b71' }} /> Integrações Brasileiras
...
### <IonicIcon name="business-outline" style={{ fontSize: '20px', color: '#ea4b71' }} /> Financeiro
...
### <IonicIcon name="library-outline" style={{ fontSize: '20px', color: '#ea4b71' }} /> Governo
...
### <IonicIcon name="location-outline" style={{ fontSize: '20px', color: '#ea4b71' }} /> Localização
