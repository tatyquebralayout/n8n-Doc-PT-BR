...
- [Guias da Comunidade para automação de iniciantes](../comunidade/automacao-iniciantes/index.mdx)
...
3. **Pratique com os [Guias da Comunidade](../comunidade/automacao-iniciantes/index.mdx)**
...
2. **Consulte [Hosting n8n](../hosting-n8n/index.mdx)** para deployment
3. **Explore [IA Avançada](../advanced-ai/index.mdx)** para automações inteligentes
